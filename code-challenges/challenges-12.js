...
const cvsFiltration = (arr) => {
    let result = [];
    arr.filter(x => {
        if (x.yearsOfExperience > 4 && x.tech == "JS") {
            result = [{ fullName: x.firstName+ " " + x.LastName,tech: x.tech,}];
        }});
         return result;
}
// -------------------------------------------------------------------------------------------------------
...
const vowelsFiltration = (arr) => {
    let arr2=[], chr=/[a||e||i||o||u]/;

  arr.filter(x => {  (!(chr.test(x)))? arr2.push(x): console.log(x);  });
return arr2;
} 
// -------------------------------------------------------------------------------------------------------
