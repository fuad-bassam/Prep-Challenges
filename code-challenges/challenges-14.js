...
const replaceWords = (str) => {
    var str2 =str.split(" "),result;
// arr1=["I","am","was"];
// arr2=["We","are","were"];
//   for(let x=0 ;x >arr1.length;x++){
   if(str2.indexOf("I")>-1){
   str2.splice( str2.indexOf("I"), 1,"We")
   result= str2.join(' ');}
//    }
if(str2.indexOf("am")>-1){
    str2.splice( str2.indexOf("am"), 1, "are")
    result= str2.join(' ');}

    if(str2.indexOf("was")>-1){
        str2.splice( str2.indexOf("was"), 1,"were")
        result= str2.join(' ');}
